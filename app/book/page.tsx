...
//             Evening:  18:00 … 21:00  (every 30 min; last call ends at 21:30)
// Weekends   → Afternoon: 13:00 … 18:30 (every 30 min; last call ends at 19:00)
...
const LABELS = {
  en: {
    ...
    privacy: <>I agree to the <a href="/privacy">Privacy policy</a>.</>,
    submit: 'Book a Demo',
    selectDateFirst: 'Select a date to see available slots.',
    groups: { lunch: 'Lunch break', evening: 'Evening', afternoon: '' } as Record<string, string>,
  },
  it: {
    ...
    privacy: <>Accetto la <a href="/privacy">Privacy policy</a></>,
    submit: 'Prenota una Demo',
    selectDateFirst: 'Seleziona una data per vedere gli orari disponibili.',
    groups: { lunch: 'Pausa pranzo', evening: 'Sera', afternoon: '' } as Record<string, string>,
  },
}
    ...
    <>
      ...
      <nav className="book-nav">
        ...
        <div className="book-nav__actions">
          <a href="/#how-it-works" className="book-nav__link">{t.navLink}</a>
        </div>
      </nav>
        ...
        <form className="book__card" onSubmit={handleSubmit}>
          ...
          <label className="book__check-wrap">
            <input
              ...
              required
            />
            <span className="book__check-label">{t.privacy}</span>
          </label>
